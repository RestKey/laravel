...
-- 7. Lấy ra danh sách người dùng có email Gmail, tên bắt đầu bằng chữ 'm'
...
-- 9. Lấy danh sách người dùng có tên chứa 'a', dài từ 5 đến 9, email Gmail và tên email chứa 'i'
...
-- 10. Lấy danh sách người dùng theo các điều kiện phức hợp
